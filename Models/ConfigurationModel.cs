...
namespace Nop.Plugin.Payments.BitCoin.Models
{
    public class ConfigurationModel : BaseNopModel, ILocalizedModel<ConfigurationModel.ConfigurationLocalizedModel>
    {
        ...
        [AllowHtml]
        [NopResourceDisplayName("Plugin.Payments.BitCoin.DescriptionText")]
        public string DescriptionText { get; set; }
        public bool DescriptionText_OverrideForStore { get; set; }

        [NopResourceDisplayName("Plugin.Payments.Bitcoin.AdditionalFee")]
        public decimal AdditionalFee { get; set; }
        public bool AdditionalFee_OverrideForStore { get; set; }

        [NopResourceDisplayName("Plugin.PaymentsBitCoin.HashBCPrivateKey")]
        public bool HashBCPrivateKey { get; set; }
